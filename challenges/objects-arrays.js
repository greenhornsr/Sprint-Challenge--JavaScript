...
const lowerCase = [];
zooAnimals.map(aNames =>{
  lowerCase.push(aNames.animal_name.toLowerCase())
})
...
*/
const largerPopulation = zooAnimals.filter(lowPopCount => {
...
zooAnimals.reduce((accumulator, popCount) =>{
  return accumulator + popCount.population
},0)
