...
const lowerCase = [];
zooAnimals.map(aNames => lowerCase.push(aNames.animal_name.toLowerCase()))
...
*/
const lowPopulation = zooAnimals.filter(lowPopCount => lowPopCount.population < 5);
...
*/
const populationTotal = zooAnimals.reduce((accumulator, popCount) => accumulator + popCount.population,0)
